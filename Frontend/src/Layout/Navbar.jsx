...
const Navbar = () => {
  ...
  <div className="flex justify-center md:justify-start md:space-x-4">
    <a href="/" className="hover:text-gray-300 text-[#131313]">Home</a>
    <Link
    to="artwork-section"
    spy={true}
    smooth={true}
    duration={500}
    className="cursor-pointer hover:text-gray-300 text-[#131313]"
    >Vision</Link>
    <Link to="event-section"
     ...
     className="cursor-pointer hover:text-gray-300 text-[#131313] ml-0 md:ml-12">About</Link>
  </div>
  <div className="w-full mt-4 md:mt-0 md:w-auto">
    <input
      ...
      className="w-full p-2 border rounded-[30px] text-black"
    />
  </div>
</nav>
