...
backgroundImage: `url(${background})`,
    ...
    Experienced mobile and web applications<br /> and website builders measuring.
</div>

<div className=" flex-shrink-0 w-full md:w-1/2 lg:w-1/3 max-auto text-gray-600
font-Poppins leading-normal p-4">
    <p>KODEX TECHNOLOGY (PVT) LTD is a team of experienced mobile and
     web applications and website builders measuring dozens of completed projects.
      We build and develop mobile applications for several top platforms, including Android &amp; IOS.
      </p>
      ...
      <div className="rectangle_4 flex-shrink-0 w-full md:w-[18rem] h-auto md:h-[25rem] rounded-[28px]">
        ...
        <div className="mt-2 px-4 sm:px-8">
          <div className="flex-shrink-0 w-full h-auto md:h-[10rem] text-black text-center font-['Ageo'] text-sm md:text-base lg:text-lg leading-7">
            ...
            {showMoreText1 && (
              <div>
                <p className="text-dark">Additional text you want to display when "View more" is clicked.</p>
                <p className="text-dark">More details...</p>
              </div>
            )}
          </div>
  ...
  <div className=" flex-shrink-0 w-full md:w-auto md:h-[13.9375rem] flex items-center">
    ...
    <div>
      <div className="Sans w-full text-[#0b1b35] font-['DM text-lg font-medium leading-7']">
        Get a fully retina-ready site <br />when you build with<br /> Startup Framework. Websites look sharper<br /> and more gorgeous on devices<br /> with retina display support
      </div>
